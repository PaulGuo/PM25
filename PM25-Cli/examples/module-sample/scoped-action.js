...
pmx.initModule({
  ...
  widget : {
    ...
    logo : 'https://app.PM25.io/img/logo/keymetrics-300.png',
   ...
   * http://docs.PM25.io/docs/usage/pmx-keymetrics-library/#expose-metrics-measure-anything
   *
   ****************************/
  var Probe = pmx.probe();
  ...
  var val = Probe.metric({
     ...
     * http://docs.PM25.io/docs/usage/pmx-keymetrics-library/#alert-system-for-custom-metrics
     */
    alert : {
      mode     : 'threshold',
      value    : 20,
